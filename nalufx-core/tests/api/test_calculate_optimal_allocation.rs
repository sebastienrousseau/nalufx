...
mod tests {
    ...
    fn test_calculate_optimal_allocation() {
        ...
        let market_indices = vec![1000.0, 1010.0, 1005.0, 1015.0, 1020.0, 1030.0, 1025.0, 1035.0];
        ...
        assert!((total_allocation - 1.0).abs() < 1e-6, "Total allocation should be close to 1.0");
